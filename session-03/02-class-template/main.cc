...
int main(int argc, char * argv[])
{
  ...
  vs.push_back("yadayada");

  std::string vs_string = vs.back();
  std::cout << "String 1: " << vs_string << std::endl;


  vs.pop_back();
  std::cout << "String 2: " << vs_string << std::endl;

  vs.push_back("yadayada2");

  std::cout << "String 3: " << vs_string << std::endl;
